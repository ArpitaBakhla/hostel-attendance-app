...
```
Agent(
  prompt="Read /home/arpita/Desktop/hostel-attendance-app/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/arpita/Desktop/hostel-attendance-app/.claude/get-shit-done/templates/VALIDATION.md`
