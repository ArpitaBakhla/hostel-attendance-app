...
```bash
INIT=$(node "/home/arpita/Desktop/hostel-attendance-app/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/arpita/Desktop/hostel-attendance-app/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
