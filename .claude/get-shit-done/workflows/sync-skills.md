...
INSTALL_JS_GLOBAL="/home/arpita/Desktop/hostel-attendance-app/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/arpita/Desktop/hostel-attendance-app/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
