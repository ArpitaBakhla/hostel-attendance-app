...
```bash
INIT=$(node "/home/arpita/Desktop/hostel-attendance-app/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/arpita/Desktop/hostel-attendance-app/.claude/get-shit-done/templates/spec.md.
